...
function Herosection() {
  return (
    <div
      className="flex flex-col mx-auto col-span-1 overflow-x-hidden relative w-full pt-36 pb-24 md:pt-44 md:pb-24 bg-neutral-50 2xl:pt-64 2xl:pb-56 animate-fadeIn object-cover"
      style={{
        backgroundImage:
