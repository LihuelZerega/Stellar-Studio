        ...
        <section className="flex flex-col items-center justify-center w-full text-center space-y-4 mb-12">
          <div className="space-y-4">
            <strong className="mb-4 text-[32px] leading-[44px] text-neutral-800">
              Why choose <span className="text-[#a482fb]">Stellar Studio</span>?
            </strong>
            <p className="mb-0 text-neutral-600 md:max-w-3xl">
              We offer a high quality website creation service. In which our
              team of professionals takes care of all the process of creating
              your custom website.
            </p>
          </div>
        </section>
        ...
        >
          <motion.div className="p-3 border-2 border-gray-200 rounded-2xl">
            ...
            <p className="text-neutral-500">
              At Stellar Studio, we understand that every business is unique. We
              offer custom online designs, adapted specifically to your needs
              and objectives.
            </p>
          </motion.div>
          <motion.div className="p-3 border-2 border-gray-200 rounded-2xl">
            ...
            <h3 className="text-neutral-700 font-semibold py-2 max-w-xs">
              No sales commissions, limit of visits, products or sales
            </h3>
            <p className="text-neutral-500">
              With Stellar Studio, your business grows without restrictions.
              Enjoy from a platform where you will not have to worry about
              commissions on your sales or limits on the number of visits,
          ...
          <motion.div className="p-3 border-2 border-gray-200 rounded-2xl">
            ...
            <p className="text-neutral-500">
              With a professional website, you can expand your business at a
              level global. You will reach new markets and potential clients,
              thus increasing your growth opportunities.
            </p>
          </motion.div>
          <motion.div className="p-3 border-2 border-gray-200 rounded-2xl">
            <div className="bg-neutral-100 p-3 rounded-full w-fit">
            ...
            <p className="text-neutral-500">
              With our intuitive tools, you can easily control your stock,
              manage orders and keep your inventory up to date. All from a
          ...
          <motion.div className="p-3 border-2 border-gray-200 rounded-2xl">
            ...
            <p className="text-neutral-500">
              Your clients will be able to pay safely and conveniently with
              options like Stripe, PayPal and MercadoPago. This not only
              improves the user experience, but also increases your rate of
              conversion.
            </p>
          </motion.div>
          <motion.div className="p-3 border-2 border-gray-200 rounded-2xl">
            ...
            <p className="text-neutral-500">
              Optionally, we integrate a chatbot into your website that will
              answer frequently asked questions from your clients automatic, 24
              hours a day. This not only improves the customer satisfaction, but
              also allows you to focus on other key areas of your business.
            </p>
          </motion.div>
        </motion.div>
      </div>
