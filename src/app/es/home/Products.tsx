  ...
  return (
    <div className="py-16 px-6 md:px-12 lg:px-24 bg-neutral-100 border-t border-neutral-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
        <a href="es/servicios/paginasweb#modelosweb" className="bg-white rounded-xl border-neutral-300 border-1 shadow-sm p-1 cursor-pointer hover:shadow-md transition-shadow duration-75">
          <div>
            <Image
        ...
        <a href="es/servicios/paginasweb#modelosweb" className="bg-white rounded-xl border-neutral-300 border-1 shadow-sm p-1 cursor-pointer hover:shadow-md hover:transition-300">
          <div>
            <Image
        ...
        <a href="es/servicios/dominios" className="bg-white rounded-xl border-neutral-300 border-1 shadow-sm p-1 cursor-pointer hover:shadow-md hover:transition-300">
          <div>
            <Image
        ...
        <a href="es/servicios/correosprofecionales" className="bg-white rounded-xl border-neutral-300 border-1 shadow-sm p-1 cursor-pointer hover:shadow-md hover:transition-300">
          <div>
            <Image
