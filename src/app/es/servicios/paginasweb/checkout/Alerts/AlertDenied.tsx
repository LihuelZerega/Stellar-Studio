...
export default function AlertDenied() {
      ...
      >
        ...
        <>
          <div className="fixed flex items-center justify-center inset-0 z-10 w-screen overflow-y-auto">
            {isLoading ? (
              <div className="flex items-center justify-center w-[512px] h-[224px] bg-white rounded-lg">
                <LoadingPage />
              </div>
            ) : (
                    ...
                    <div className="bg-white px-4 pt-5 flex items-center justify-center">
                      <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-12 sm:w-12">
                        <ExclamationTriangleIcon
                          className="h-8 w-h-8 text-red-600"
                          aria-hidden="true"
                        />
                      </div>
                    </div>
                    <div className="bg-white px-4 pb-4 pt-2 sm:pb-4">
                      <div className="flex tems-center">
                        <div className="mt-3 text-left sm:mt-0 sm:text-center">
                          ...
                          >
                            Solicitud de orden denegada
                          </Dialog.Title>
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              Faltan datos por rellenar o la información es
                              incorrecta. Por favor, intenta de nuevo. Si el
                              problema persiste, contacta con nuestro equipo de
                              soporte.
                            </p>
                          </div>
                        </div>
