            ...
            <div className="flex items-center justify-between h-16 lg:h-20">
              ...
              <div className="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
                <a
                  href="#features"
                  title=""
                  className="text-base text-white transition-all duration-200 hover:text-opacity-80 ml-8"
                >
                  {" "}
                  Features{" "}
                </a>
        ...
        <section className="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div className="max-w-xl mx-auto text-center">
              <h1 className="text-4xl font-bold sm:text-6xl mt-12">
              ...
              <a
                href="#solutions"
                title=""
                className="inline-flex items-center px-6 py-4 md:ml-8 mt-8 font-semibold text-white transition-all duration-200 border-2 border-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700"
                role="button"
              >
                Discover more
              </a>
