        ...
        <section className="">
          <div className="grid grid-cols-1 gap-x-12 text-center sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
            <div>
              ...
              <h3 className="mt-8 text-lg font-semibold text-neutral-800">
                No annual charges
              </h3>
              <p className="mt-4 text-base text-neutral-600">
                Enjoy your card without hidden rates.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-base text-neutral-600">
              Make your payments quickly and safely.
              </p>
            </div>
