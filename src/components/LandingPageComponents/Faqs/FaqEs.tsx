...
function FaqEs() {
  ...
  const Response2 =
    "El servicio de diseño de landing page incluye la creación de una página web única y específica diseñada para convertir visitantes en clientes potenciales o clientes. Esto incluye el diseño visual de la página, la redacción de contenido persuasivo, la optimización de la experiencia del usuario, la integración de formularios de contacto o de suscripción, etc.";
  const Response3 =
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-300">
              Encontrá respuesta a las dudas comunes.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto mt-8 space-y-4 md:mt-12">
          ...
          >
            <AccordionItem
              ...
              title={
                <h4 className="text-white">
                  ¿Cuáles son los beneficios de tener un sitio web para mi negocio?
                </h4>
              }
            >
              {Response1}
            ...
            <AccordionItem
              ...
              title={
                <h4 className="text-white">
                  ¿Cuáles son las diferencias entre el plan Landing Page y el plan E-commerce?
                </h4>
              }
            >
              {Response4}
            ...
            <AccordionItem
              ...
              title={
                <h4 className="text-white">
                  ¿Cómo se optimiza mi sitio web para los motores de búsqueda SEO?
                </h4>
              }
            >
              {Response6}
