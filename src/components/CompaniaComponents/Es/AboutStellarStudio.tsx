  ...
  return (
    <>
      <div className="px-6 sm:px-12 lg:px-0 sm:max-w-3xl xl:max-w-6xl mx-auto">
            ...
            <div>
              ...
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  ...
                  ofrecer un servicio integral que permita a los propietarios de
                  pequeñas empresas y emprendedores concentrarse en lo que hacen
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  ...
                  tecnología. Con Stellar Studio a su lado, pueden estar seguros
                  de que tienen un equipo experimentado y apasionado que los
                  respalda en cada paso del camino.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div>
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  ...
                  confiable de nuestros clientes en su viaje hacia la excelencia
                  en línea, ofreciendo servicios de desarrollo web, diseño
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  ...
                  visibilidad en línea. Nuestro compromiso con la calidad, la
                  creatividad y la innovación impulsa todo lo que hacemos, y nos
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                ...
                <div className="mt-6 text-lg leading-8 text-gray-300">
                  ...
                  primer lugar y nos esforzamos por superar sus expectativas en
                  cada proyecto. Estamos comprometidos a brindar un servicio
                  excepcional y a construir relaciones sólidas y duraderas con
                  nuestros clientes.
                </div>
              </div>
            </div>
        ...
        <section className="pt-32">
          <h1 className="text-center text-5xl font-bold tracking-tight text-[#a482fb]">
            Clientes Destacados
          </h1>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-4 mt-6 lg:mt-0">
            <div className="glass-container bg-opacity-5 backdrop-filter backdrop-blur-lg bg-[#a482fb] shadow-lg p-6 border-2 rounded-2xl border-[#a482fb] my-4 lg:my-24 mx-auto max-w-7xl">
              <h1 className="text-2xl text-[#a482fb] mb-2">
                EcoTech Solutions
              </h1>
              <p className="text-white">
                Una empresa líder en tecnología verde que se especializa en
                soluciones sostenibles para el medio ambiente. Trabajamos
                estrechamente con EcoTech Solutions para desarrollar una
                plataforma en línea que facilita la gestión de residuos y
                fomenta la adopción de prácticas ecoamigables.
              </p>
            </div>
            <div className="glass-container bg-opacity-5 backdrop-filter backdrop-blur-lg bg-[#a482fb] shadow-lg p-6 border-2 rounded-2xl border-[#a482fb] my-4 lg:my-24 mx-auto max-w-7xl">
              <h1 className="text-2xl text-[#a482fb] mb-2">Healthy Bites</h1>
              <p className="text-white">
                Una startup de alimentos saludables que ofrece opciones de
                comida nutritiva y equilibrada. Colaboramos con Healthy Bites
                para diseñar y desarrollar su sitio web de comercio electrónico,
                lo que les permitió llegar a una audiencia más amplia y aumentar
                sus ventas en línea.
              </p>
            </div>
            <div className="glass-container bg-opacity-5 backdrop-filter backdrop-blur-lg bg-[#a482fb] shadow-lg p-6 border-2 rounded-2xl border-[#a482fb] my-4 lg:my-24 mx-auto max-w-7xl">
              ...
              <p className="text-white">
                Una agencia de viajes especializada en aventuras y experiencias
                únicas en todo el mundo. Trabajamos en estrecha colaboración con
                Adventure Seekers para mejorar su presencia en línea y crear una
                plataforma de reserva fácil de usar que mejoró la experiencia
                del cliente y aumentó las reservas de viajes.
              </p>
            </div>
          </div>
        </section>
          ...
          <div>
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-neutral-100">
                ...
                sea sinónimo de excelencia en el diseño web, desarrollo de
                aplicaciones y estrategias digitales. Queremos ser la primera
                opción para las empresas que buscan expandir su presencia en
                línea y aumentar su impacto en el mundo digital. Nos vemos como
                un socio estratégico para nuestros clientes, brindándoles las
...
export default AboutStellarStudio;
