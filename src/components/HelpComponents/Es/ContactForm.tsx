    ...
    <div className="isolate border-t-1 border-neutral-200 bg-neutral-50 px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                <select
                  id="country"
                  name="country"
                  className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#a482fb] sm:text-sm"
                >
                  <option>AR</option>
                  <option>BR</option>
                  <option>ES</option>
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-[#a482fb] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#a482fb]"
          >
            Enviar
          </button>
        </div>
